    ...
    <>
      <footer className="new_img  text-black pt-3 pb-0">
        <div className="container" data-select2-id="10">
          <div className=" text-center title my-md-4  pt-md-3 p-3">
            <h2 className=" text-black    mb-4 text-uppercase">
              Store. The best way to buy the products you love.
              {/* THE BRAND OF APPLE new way of{" "}
              LIVING */}
            </h2>
            <p className="text-gray Fweight-600 font-size-16 text-uppercase">
              Designed with both style and function in mind, the new iPhone
              Leather Wallet with MagSafe is the perfect way to keep your credit
              and debit cards close at hand. It now supports Find My, so you can
              be notified of your wallet’s last known location if it gets
              separated from your
            </p>
          </div>
          <div
            className="row justify-content-md-between gutter-2 pb-1 text-center"
            data-select2-id="17"
          >
            {/* <!-- menu --> */}
            <div className="order-1 col-md-8 col-lg-4 ">
              <div className="row ">
                <div className="col">
                  <h5 className=" mb-1 fa-2x">COMPANY</h5>
                ...
                <div className="col">
                  <h4 className="mb-1 fa-2x">Help Center</h4>
            ...
            <div className="order-3 order-md-3 order-lg-2 col-md-12 col-lg-4">
              <h4 className="mb-1 fa-2x">Subscribe to New Update</h4>
            ...
            {/* <!-- settings --> */}
            <div
              className="order-2 order-md-2 order-lg-3 col-md-4 col-lg-3 text-center mb-2"
              data-select2-id="16"
            >
        ...
        <div className="">
        <p className="mb-0 text-center text-dark  py-2  border-top border-secondary font-size-14">
